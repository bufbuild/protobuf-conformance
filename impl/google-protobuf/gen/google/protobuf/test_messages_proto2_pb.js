...
proto.protobuf_test_messages.proto2.TestAllTypesProto2.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(104, writer, jspb.BinaryWriter.prototype.writeInt32, jspb.BinaryWriter.prototype.writeBool);
  }
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(103, writer, jspb.BinaryWriter.prototype.writeInt32, jspb.BinaryWriter.prototype.writeMessage, proto.protobuf_test_messages.proto2.TestAllTypesProto2.NestedMessage.serializeBinaryToWriter);
  }
