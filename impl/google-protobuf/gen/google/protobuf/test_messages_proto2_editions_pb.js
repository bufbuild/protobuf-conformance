...
proto.protobuf_test_messages.editions.proto2.TestAllTypesProto2.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 65:
      ...
      break;
    case 104:
      var value = msg.getMapInt32BoolMap();
      reader.readMessage(value, function(message, reader) {
...
jspb.internal.public_for_gencode.serializeMapToBinary(
  ...
  f = message.getMapInt32BoolMap(true);
  if (f && f.getLength() > 0) {
jspb.internal.public_for_gencode.serializeMapToBinary(
    message.getMapInt32BoolMap(true),
    104,
    writer,
    jspb.BinaryWriter.prototype.writeInt32,
...
jspb.internal.public_for_gencode.serializeMapToBinary(
  ...
  f = message.getMapInt32NestedMessageMap(true);
  if (f && f.getLength() > 0) {
jspb.internal.public_for_gencode.serializeMapToBinary(
    message.getMapInt32NestedMessageMap(true),
    103,
    writer,
    jspb.BinaryWriter.prototype.writeInt32,
...
jspb.internal.public_for_gencode.serializeMapToBinary(
  ...
  f = message.getMessageSetCorrect();
  if (f != null) {
    writer.writeMessage(
      500,
      f,
