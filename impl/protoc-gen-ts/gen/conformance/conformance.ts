...
export namespace conformance {
    ...
    export class ConformanceResponse extends pb_1.Message {
        #one_of_decls: number[][] = [[1, 6, 2, 3, 4, 5, 7, 8]];
        constructor(data?: any[] | ({} & (({
            parse_error?: string;
        ...
        get result() {
            const cases: {
                [index: number]: "none" | "parse_error" | "serialize_error" | "runtime_error" | "protobuf_payload" | "json_payload" | "skipped" | "jspb_payload" | "text_payload";
            } = {
                0: "none",
                1: "parse_error",
                6: "serialize_error",
            ...
            return cases[pb_1.Message.computeOneofCase(this, [1, 6, 2, 3, 4, 5, 7, 8])];
        }
        static fromObject(data: {
            parse_error?: string;
            serialize_error?: string;
