...
export const TestStatus: MessageFns<TestStatus> = {
  ...
  fromJSON(object: any): TestStatus {
    return {
      ...
      failureMessage: isSet(object.failureMessage)
        ? globalThis.String(object.failureMessage)
        : isSet(object.failure_message)
        ? globalThis.String(object.failure_message)
        : "",
      matchedName: isSet(object.matchedName)
        ? globalThis.String(object.matchedName)
        : isSet(object.matched_name)
        ? globalThis.String(object.matched_name)
        : "",
    };
  },
  ...
  fromJSON(object: any): ConformanceRequest {
    return {
      payload: isSet(object.protobufPayload)
        ...
        : isSet(object.protobuf_payload)
        ? { $case: "protobufPayload", protobufPayload: bytesFromBase64(object.protobuf_payload) }
        : isSet(object.jsonPayload)
        ? { $case: "jsonPayload", jsonPayload: globalThis.String(object.jsonPayload) }
        : isSet(object.json_payload)
        ? { $case: "jsonPayload", jsonPayload: globalThis.String(object.json_payload) }
        : isSet(object.jspbPayload)
        ? { $case: "jspbPayload", jspbPayload: globalThis.String(object.jspbPayload) }
        : isSet(object.jspb_payload)
        ? { $case: "jspbPayload", jspbPayload: globalThis.String(object.jspb_payload) }
        : isSet(object.textPayload)
        ? { $case: "textPayload", textPayload: globalThis.String(object.textPayload) }
        : isSet(object.text_payload)
        ? { $case: "textPayload", textPayload: globalThis.String(object.text_payload) }
        : undefined,
      requestedOutputFormat: isSet(object.requestedOutputFormat)
        ? wireFormatFromJSON(object.requestedOutputFormat)
        : isSet(object.requested_output_format)
        ? wireFormatFromJSON(object.requested_output_format)
        : 0,
      messageType: isSet(object.messageType)
        ...
        : "",
      testCategory: isSet(object.testCategory)
        ? testCategoryFromJSON(object.testCategory)
        : isSet(object.test_category)
        ? testCategoryFromJSON(object.test_category)
        : 0,
      jspbEncodingOptions: isSet(object.jspbEncodingOptions)
        ? JspbEncodingConfig.fromJSON(object.jspbEncodingOptions)
        : isSet(object.jspb_encoding_options)
        ? JspbEncodingConfig.fromJSON(object.jspb_encoding_options)
        : undefined,
      printUnknownFields: isSet(object.printUnknownFields)
        ? globalThis.Boolean(object.printUnknownFields)
        : isSet(object.print_unknown_fields)
        ? globalThis.Boolean(object.print_unknown_fields)
        : false,
    };
  },
  ...
  fromJSON(object: any): ConformanceResponse {
    return {
      result: isSet(object.parseError)
        ...
        : isSet(object.parse_error)
        ? { $case: "parseError", parseError: globalThis.String(object.parse_error) }
        : isSet(object.serializeError)
        ? { $case: "serializeError", serializeError: globalThis.String(object.serializeError) }
        : isSet(object.serialize_error)
        ? { $case: "serializeError", serializeError: globalThis.String(object.serialize_error) }
        : isSet(object.timeoutError)
        ? { $case: "timeoutError", timeoutError: globalThis.String(object.timeoutError) }
        : isSet(object.timeout_error)
        ? { $case: "timeoutError", timeoutError: globalThis.String(object.timeout_error) }
        : isSet(object.runtimeError)
        ? { $case: "runtimeError", runtimeError: globalThis.String(object.runtimeError) }
        : isSet(object.runtime_error)
        ? { $case: "runtimeError", runtimeError: globalThis.String(object.runtime_error) }
  ...
  fromJSON(object: any): JspbEncodingConfig {
    return {
      useJspbArrayAnyFormat: isSet(object.useJspbArrayAnyFormat)
        ...
        : isSet(object.use_jspb_array_any_format)
        ? globalThis.Boolean(object.use_jspb_array_any_format)
        : false,
    };
  },
