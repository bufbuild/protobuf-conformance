...
import { ConformanceRequest, ConformanceResponse, FailureSet, TestCategory, WireFormat, } from "../gen/conformance/conformance_pb.js";
...
import { Any, createRegistry, Duration, FieldMask, Int32Value, Struct, Timestamp, Value, } from "@bufbuild/protobuf";
const registry = createRegistry(Value, Struct, FieldMask, Timestamp, Duration, Int32Value, TestAllTypesProto3, TestAllTypesProto2, Any);
function main() {
    let testCount = 0;
    try {
        while (testIo(test)) {
        ...
        process.stderr.write(`conformance.ts: exiting after ${testCount} tests: ${String(e)}`);
        process.exit(1);
    }
}
    ...
    try {
        switch (request.payload.case) {
            ...
            default:
                ...
                return {
                    case: "runtimeError",
                    value: `${(_a = request.payload.case) !== null && _a !== void 0 ? _a : "?"} not supported`,
                };
        }
    }
    catch (err) {
